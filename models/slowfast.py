...
if __name__ == "__main__":
    ...
    path = '/projects/vode/team1/I3D/kidnap/'
    


    for i in lines:

        trans = transforms.Compose([transforms.Resize((224,224)),   #224_resized

        # trans = transforms.Compose([transforms.CenterCrop(224),   #224_centercrop
        ...
        make = torch.zeros((1,3,64,224,224))    #224

        num_classes = 2
        model = resnet50(class_num=num_classes)

        weights = torch.load('slowfast_weight.pth')['state_dict']
        ...
        for j,data in enumerate(trainloader):
            ...
            target_dir = '/projects/vode/test_numpy/kidnap/numpy_SlowFast/'+i+'/'
