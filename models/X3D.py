...
if __name__ == "__main__":
    ...
    path = '/projects/vode/team1/X3D/swoon/'
    path_2 = '/projects/vode/numpy/data_numpy_X3D_M_re/swoon/'

    file_list = os.listdir(path)
    file_list_2 = os.listdir(path_2)
    final = [i for i in file_list if i not in file_list_2]
    ...
    for i in final:
        ...
        for j,data in enumerate(trainloader):
            ...
            target_dir = '/projects/vode/numpy/data_numpy_X3D_M_re/swoon/'+i+'/'
